...
{
    [MenuItem("Tools/Enemy Waypoint Editor")]
    ...
    public void OnGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("Root tranform must be assigned.", MessageType.Warning);
        }
        else
        {
    ...
    void CreateWaypoint()
    {
        ...
        if (waypointRoot.childCount > 1)
        {
            ...
            // Place the waypoint at the last waypoints position
